...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Jonathan\PycharmProjects\physical_tools'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Jonathan\PycharmProjects\physical_tools\Scripts\deactivate.nu'
